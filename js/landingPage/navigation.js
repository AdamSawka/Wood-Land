        ...
        <>
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container px-4 px-lg-5">
                     <Link to="/" className="navbar-brand" href="../../index.html"><img src="../../img/logo.png" alt="logo" className="mx-2 bg-light"/></Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                            ...
                            <li className="nav-item mx-4"><Link to="" className="nav-link" href="#">O nas</Link></li>
                            <li className="nav-item mx-4"><Link to="" className="nav-link" href="#">Kontakt</Link></li>
                            <li className="nav-item mx-4 dropdown">
                                <a className="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button"
                                   data-bs-toggle="dropdown" aria-expanded="false" onClick={toggleOpen}>Sklep</a>
                                <ul className={` bg-light position-absolute ${menuClass} `} aria-labelledby="navbarDropdown">
                                    <li><Link to="/shop/itemsAll" className="dropdown-item" href="#">Wszystkie produkty</Link></li>
                ...
                <Switch>
                    <Route exact path="/shop/itemsAll">
                        <ItemsAll/>
                    </Route>
