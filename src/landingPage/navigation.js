                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                            <li className="nav-item">
                                <Link to="" className="nav-link active" aria-current="page">Strona główna</Link></li>
                            ...
                            <li className="nav-item mx-4 dropdown">
                                <Link to=" " className="nav-link dropdown-toggle" id="navbarDropdown" role="button"
                                      data-bs-toggle="dropdown" aria-expanded="false" onClick={toggleOpen}>Sklep</Link>
                                <ul className={` bg-light position-absolute ${menuClass} `}
                                    aria-labelledby="navbarDropdown">
                                    <li><Link to="/itemsAll" className="dropdown-item">Wszystkie
                                        produkty</Link></li>
                                    <li><Link to=" " className="dropdown-item">Popularne</Link></li>
                                    <li><Link to=" " className="dropdown-item ">Nowości</Link></li>
                                </ul>
                            </li>
                        </ul>
                        <ul className="navbar-nav mb-2 mb-lg-0 ms-lg-4">
                            <li className="nav-item mx-4"><Link to="/login" className="nav-link">Zarejestruj się</Link>
                            </li>
                        </ul>
